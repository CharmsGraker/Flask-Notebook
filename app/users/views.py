...
def dashboard():
    ...
    if notes:
        return render_template('dashboard.html', articles=notes, form=form,user=current_user)
    else:
        msg = '暂无笔记信息'
        return render_template('dashboard.html', msg=msg, form=form, user=current_user)


@users.route('/add_article', methods=['GET', 'POST'])
@login_required
def add_article():
...
@users.route('edit_article/<int:article_id>', methods=['GET', 'POST'])
@login_required
...
@users.route('/view_article/<article_id>')
@login_required
...
@users.route('/delete_article/<int:article_id>', methods=['POST'])
@login_required
...
@users.route('/my_post/<int:user_id>')
@login_required
def my_post(user_id):
